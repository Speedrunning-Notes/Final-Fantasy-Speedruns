...
\begin{enumerate}[resume]
    ...
    \ifthenelse{\equal{\blitzresult}{win}}{%
        ...
        \item Need 4 (6 if \blitzloss\ and you have less than 2 Bomb Cores)
    }{%
        \item Need 6 (4 if you still have 2 Bomb Cores)
    }} in any combination of Silence Grenades, Sleeping Powders, Smoke Bombs
\end{enumerate}
\begin{enumerate}[resume]
...
\begin{enumerate}[resume]
    ...
    \item You need 22 Power Spheres and 11 Speed Spheres \textbf{at this point} to be done farming them.
    \lossnp
    ...
    \end{itemize}
\end{enumerate}
\lossnpsingle\bothnpsingle\winnpsingle
