...
\end{battle}
\begin{enumerate}[resume]
    \item Go down the stairs. Once the camera flips, \blitzballdetermination[]{If \rikku\ doesn't have \od\ \formation{\tidus}{\rikku}{\kimahri}, else \formation{\tidus}{\rikku}{\auron}}{\formation{\tidus}{\rikku}{\auron}}
    \blitzballdetermination[true]{}{%
        ...
        \begin{battle}{Dual Horns}
            ...
            \end{itemize}
        \end{battle}
        \item If \rikku\ doesn't have \od\ \formation{\tidus}{\rikku}{\kimahri}, else \formation{\tidus}{\rikku}{\auron}
