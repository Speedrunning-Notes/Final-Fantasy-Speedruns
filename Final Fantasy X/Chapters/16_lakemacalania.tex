...
\begin{battle}[18000]{Wendigo}
    Turns in this fight can be a bit random - Treat each character independently of each other, doing their actions as their turn comes up.
    \begin{itemize}
        \tidusf Haste \tidus
        ...
        \switch{\yuna}{\lulu}
        \luluf Defend
        \blitzballdetermination[true]{\tidusf Haste \rikku\
        \rikkuf Attack
        \enemyf Counterattack \rikku\ - take note of whether or not she has \od
        \tidusf \od\ Spiral Cut}
        \blitzballdetermination[false]{\switch{\tidus}{\kimahri}
        \kimahrif Lightning Marble/Arctic Wind
        \rikkuf Attack
        \kimahrif Attack
        \switch{\lulu}{\tidus}
        \tidusf Cheer x2
