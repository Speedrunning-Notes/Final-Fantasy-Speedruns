...
\begin{spheregrid}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item HP +200, Agi+4
		\end{itemize}
		\ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.8\columnwidth]{graphics/macalania_kimahri}}{\includegraphics[width=.5\columnwidth]{graphics/macalania_kimahri}}
		\tidusf (22 S.Lvl)
		\begin{itemize}
...
\begin{battle}[18000]{Anima}
	\begin{itemize}
		\blitzballdetermination[true]{%
			...
			\switch{first survivor}{\tidus}
			\tidusf Attack x4
			\item second survivor: switch for \rikku or \kimahri
