...
\begin{enumerate}
    ...
    \item \textit{If you have 2 or more Sleeping Powders} do the following strats, otherwise \formation{\tidus}{\rikku}{\lulu} and do the next set of strats
\end{enumerate}
...
\begin{battle}{Guard Fights - No Sleeping Powder}
    Keep \formation{\tidus}{\rikku}{\lulu} for the first 4 fights, \formation{\tidus}{\rikku}{\kimahri} for the last one
    \begin{itemize}
        \item \textit{Fights 1 and 3 (3 Monks):}
        \begin{itemize}
            \tidusf Attack
...
\end{enumerate}
\bothcb\winnp\losscb\bothnpsingle\winnpsingle\lossnpsingle
