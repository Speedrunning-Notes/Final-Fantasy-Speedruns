...
\begin{enumerate}[resume]
	...
	\item Need \ifthenelse{\equal{\blitzresult}{loss}}{7}{6} (\ifthenelse{\equal{\blitzresult}{loss}}{5}{4} if you still have 2 Bomb Cores)\ifthenelse{\equal{\blitzresult}{both}}{ (+1 if on \blitzloss)}{} in any combination of Silence Grenades, Sleeping Powders, Smoke Bombs
	...
	\blitzballdetermination[true]{
		\item After the Forced Encounter with \rikku: \textit{if you need to Steal or need to charge \rikku's \od} \formation{\tidus}{\rikku}{\auron}, otherwise \formation{\tidus}{\kimahri}{\auron}
	}{
		\item After the Forced Encounter with \rikku: \formation{\tidus}{\rikku}{\auron}
	}
\end{enumerate}
