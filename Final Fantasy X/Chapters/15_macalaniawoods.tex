        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \ifthenelse{\equal{\blitzresult}{win}}{%
                    \item \includegraphics[width=.8\columnwidth]{graphics/Kimahri_post_spheremorph}
                }{\ifthenelse{\equal{\blitzresult}{both}}{%
                    \item \includegraphics[width=.8\columnwidth]{graphics/Kimahri_post_spheremorph}
                }{%
                    \item \includegraphics[width=.8\columnwidth]{graphics/Kimahri_post_spheremorph_loss}
                }}
            \end{itemize}
        \end{itemize}
    \end{multicols}
