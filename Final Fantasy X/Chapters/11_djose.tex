...
\begin{enumerate}[resume]
    ...
    \item Speak to \auron, enter the temple and go to the left room. Speak to the priest, \sd. Exit the temple, \sd. Run south to the bridge, \sd
    \item Speak to the first guard on your left to obtain a \textbf{Halberd}, continue crossing the bridge, \sd, exit, \sd, go up to Moonflow
\end{enumerate}
