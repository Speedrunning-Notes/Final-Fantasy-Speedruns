...
\begin{spheregrid}
    \begin{itemize}
        ...
        \blitzballSphereGrid{%
            ...
            \item Move $\rightarrow\rightarrow$
            \item Def+3
        }{.7}{.4}{graphics/Yuna_blitz_loss_highbridge_1_mdef}
    \end{itemize}
\end{spheregrid}
\begin{enumerate}
    ...
    \item Need 4 Maze Larva/YKT-63 Kills total, Overkills count as 1. Flee any Ambushes.
    \item Walk north
\end{enumerate}
\begin{encounters}
    \begin{itemize}
...
\begin{battle}[36000]{Seymour Natus}
    \begin{itemize}
        \item \textit{If you bought a Distiller:}
        \begin{itemize}
            \tidusf Distiller Natus (+4 of whatever you distilled)
        \end{itemize}
        \tidusf Attack
        \summon{\bahamut}
        \bahamutf Attack
