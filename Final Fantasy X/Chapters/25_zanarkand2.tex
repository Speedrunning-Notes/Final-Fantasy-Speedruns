...
\begin{enumerate}
    ...
    \item You can charge \rikku's \od\ on an encounter with a Defender Z (Escape with the others).
...
\end{spheregrid}
\begin{enumerate}[resume]
    \item \textit{If \rikku\ doesn't have \od} \formation{\tidus}{\rikku}{\yuna}, otherwise \formation{\tidus}{\auron}{\yuna}
    \bothnp
...
\begin{battle}[52000]{Spectral Keeper}
    \begin{itemize}
        \item \textit{If \rikku\ doesn't have \od}
        \begin{itemize}
            \yunaf Move on the left Circle (Boss \#4)
            \tidusf Haste \yuna
            \rikkuf Attack
        \end{itemize}
        \summon{\bahamut}
