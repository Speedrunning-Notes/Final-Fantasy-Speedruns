...
\begin{spheregrid}
    \begin{itemize}
        \item \textit{If you had 4 \textbf{Return Spheres}}:
            ...
            \end{itemize}
    \end{itemize}
    \ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.5\columnwidth]{graphics/2_and_2_with_luck}}{\includegraphics[width=.25\columnwidth]{graphics/2_and_2_with_luck}}
\end{spheregrid}
\begin{enumerate}[resume]
