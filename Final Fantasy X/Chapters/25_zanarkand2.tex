    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item MP+20, Str+2
            \end{itemize}
            \ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.5\columnwidth]{graphics/yuna_returns_to_fire_2_returns}}{\includegraphics[width=.2\columnwidth]{graphics/yuna_returns_to_fire_2_returns}}
...
\begin{spheregrid}
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \ifthenelse{\equal{\colstyle}{multi}}{\includegraphics[width=.5\columnwidth]{graphics/yuna_returns_to_fire_4_returns}}{\includegraphics[width=.25\columnwidth]{graphics/yuna_returns_to_fire_4_returns}}
\end{spheregrid}
\begin{enumerate}[resume]
