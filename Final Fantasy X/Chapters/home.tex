...
\end{battle}
\begin{enumerate}[resume]
    \item Go down the stairs. Once the camera flips, \blitzballdetermination{\formation{\tidus}{\lulu}{\auron}}{\formation{\tidus}{\rikku}{\auron}}
    \blitzballdetermination[true]{}{%
        \item Heal \tidus\ (don't use Elixirs)
