...
\begin{battle}[1800]{Garuda}
    ...
    \end{itemize}
    Check if \tidus\ has 2 S.Levels
    Guaranteed 2 Power Spheres from this and the Vouivre. Any Overkills are +1 Power Sphere each
\end{battle}
\begin{enumerate}[resume]
    ...
    \item Do the below grid if \tidus\ has 2 S.Levels
    \begin{spheregrid}
    	\begin{itemize}
    		\tidusf (2 S.Lvl)
    		\begin{itemize}
    			...
    			\item +200 HP
    		\end{itemize}
    		\sggraphics{.7}{.4}{graphics/Tidus_post_garuda}
    	\end{itemize}
    \end{spheregrid}
    \item If you did the above grid, \formation{\tidus}{\wakka}{\auron} then \save.
