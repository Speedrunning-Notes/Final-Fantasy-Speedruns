...
\begin{battle}{Rikku Tutorial}
    \begin{itemize}
        ...
        \begin{itemize}
            \rikkuf \od\ Two Ability Spheres, also check how many Speed Spheres you have (you need 17 to be done farming them)
        \end{itemize}
        \item \textit{Else:}
        \begin{itemize}
            \rikkuf \od\ Two Potions or Hi-Potions, also check how many Speed Spheres you have (you need 17 to be done farming them)
            \rikkuf Defend
            \item Flee
        \end{itemize}
    \end{itemize}
...
\begin{spheregrid}
    \begin{itemize}
        \tidusf (4 S.Lvl)
        \begin{itemize}
            \item Move $\rightarrow\uparrow$ ($\uparrow\uparrow$ if you are on the Accuracy node instead of the Strength node)
            \item Str+1, HP+200 (if you don't already have it), Agil+2
        \end{itemize}
