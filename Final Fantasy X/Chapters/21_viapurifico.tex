...
\begin{spheregrid}
    \begin{itemize}
        ...
        \sggraphics{.7}{.4}{graphics/via_purifico_yuna_2_acc}
    \end{itemize}
\end{spheregrid}
...
\end{battle}
\begin{enumerate}[resume]
    \item You can use the underwater chest on the right at the start to buy a Speed Distiller (this is the last convenient opportunity to acquire Speed Spheres) or a Power Distiller. If you buy a Distiller here it is worth +4 of whichever one you bought.
...
\begin{battle}{Evrae Altana}
    \begin{itemize}
        \item Anyone: Elixir x2 Evrae Altana
    \end{itemize}
\end{battle}
\begin{enumerate}[resume]
