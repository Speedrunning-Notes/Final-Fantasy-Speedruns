...
\end{battle}
\begin{enumerate}[resume]
    \item \textit{If you need any Spheres and didn't buy any Distillers:}
    \begin{itemize}
        \item Buy up to 2 Distillers from the Chest Shop on the right
        \item The first Distiller can be used on Seymour Natus, it counts as 4 Spheres
        \item The second Distiller can be used on Evrae Altana, it counts as 2 Spheres
        \item If you need more than 6 Spheres total, prioritize Speeds, this is the last opportunity to gain them easily
    \end{itemize}
