...
\begin{enumerate}[resume]
	...
	\item \important{You need 240 encounters before entering the temple (206 Random Encounters). Valefor should have 1229 Max HP. If you need more encounters you can grind them in the Crevasse. Equip Brotherhood only \textbf{after} grinding encounters.}
\end{enumerate}
\begin{equip}
	\begin{itemize}
		\item Brotherhood
